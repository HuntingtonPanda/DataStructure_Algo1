...
// Table::Table(string _name):name(_name){
//     char _fileName[name.size() + 5];
//     strcpy(_fileName, name.c_str());
//     strcat(_fileName, ".bin");
//     open_fileRW(f, _fileName);
...
//     list_category.close();
//     open_fileRW(list_category, _fileName); 
...
//     while (byteRead > 0){
//         for(int i = 0; i < category.size(); i++)
//             organize[i].insert(tempVStr[i], a);
...
//     // long byteRead = temp.scribe.read(read, a);     //read the readirst record
...
//     // } 
//     // while (byteRead > 0){
//     //     selected.push_back(long(a));
//     //     a++;
//     //     temp.insert_into(tempVStr);
//     //     RecNum ++;

//     //     byteRead = temp.scribe.read(read, a);         //read next record.
//     //     for (int i = 0; i < category.size(); i++){
//     //         tempVStr[i] = string(temp.scribe._record[i]);
//     //         //cout << "record: " << i << " VSTR:" << tempVStr[i] << endl;
//     //     } 
...
//                 if(stack.empty())
//                         throw("Expected: Argument for Relational");
...
//                             // cout << "index[second->get_string()]: " << index[second->get_string()] << endl;
//                             // cout << "organize[index[second->get_string()]]: " << organize[index[second->get_string()]] << endl;
//                             // cout << "it: " << (*it).value_list << endl;
...
//                 case LOGICAL:
//                     if(stack.empty())
//                         throw("Expected: Argument for Logical");
