...
/*20*/     "select * from student where lname>J and major=CS or (major=Art and fname = \"Flo\")",
/*21*/    "select * from student where (major=CS or major=Art) and (lname=   Jackson or lname=Yang) or lname = Davis and age = 30"
