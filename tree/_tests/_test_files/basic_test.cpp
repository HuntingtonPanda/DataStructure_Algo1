...
bool table_basic(bool debug = false){
     ...
     //cout << "tbl_student mmap test print\n";
     //tbl_student.test_print();
...
bool condition_from_strings(bool debug = false){
     ...
     vector<string> condition2 = {"age", ">", "10", "and", "age", "<", "20", "or", "fname", "=", "Flo" };
     Table selected2 = t.select({"fname", "lname", "age"}, condition2);
     cout << "recnos from all all younger than 17, all older than 20, who are Jacksons: " << t.select_recnos() << endl;
     cout << endl
          << selected2 << endl;
     return true;
